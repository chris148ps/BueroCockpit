# Codex-Journal – Einordnung

Die Dateien in diesem Ordner sind unveränderliche historische Laufprotokolle.
Sie beschreiben den jeweils damaligen Stand und sind keine aktuelle
Projekt-, Fach-, Design-, Test- oder Release-Regel.
